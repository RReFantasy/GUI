...
PickingTexture::PixelInfo PickingTexture::ReadPixel(unsigned int x, unsigned int y)
{
	...
	// It takes a rectangle which is specified using its bottom left corner (first pair of params) and 
	// its width/height (second pair of params) and reads the results into the address given by the last param. 
